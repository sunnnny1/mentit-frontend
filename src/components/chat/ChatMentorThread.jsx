...
export const EUNOIA_MENTOR_CONVERSATION = [
  {
    role: 'user',
    texts: [
      '안녕하세요! 프로덕트 디자이너에 지원 희망하는 이윤영입니다. AI 에이전트랑 얘기하다가 궁금한 게 더 생겨서 연락드렸습니다!',
...
export const TEDDY_MENTOR_CONVERSATION = [
  {
    role: 'user',
    texts: [
      '안녕하세요! UX 디자이너에 지원 희망하는 이윤영입니다. AI 에이전트랑 얘기하다가 궁금한 게 더 생겨서 연락드렸습니다!',
    ],
  },
  {
    role: 'mentor',
  ...
  },
  {
    role: 'user',
    texts: [
      '아직 취준생이지만, UX 디자이너로 취업하게 된다면 실무에서 정확히 어떤 일을 하는지, 어떤 점이 가장 예상과 달랐는지 궁금합니다.',
    ],
  },
  {
    role: 'mentor',
  ...
  },
  {
    ...
    texts: [
      '완전 실용적이네요!! "왜 있었지" "누가 얼마나 쓰지" 이 두 가지면 저도 포폴 만들 때 뭘 넣고 뺄지 헷갈릴 때 바로 써볼 수 있을 것 같아요. ',
      '자세한 설명 정말 감사합니다! 덕분에 UX 디자이너 직무에 더 열정이 생긴 것 같습니다. 추후 궁금한게 생긴다면 또 질문해도 괜찮을까요??',
    ],
  },
  {
    role: 'mentor',
